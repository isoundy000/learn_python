...
var get_resource = function () {
    ...
    my_ajax(true, "/resource/getresourceversion2", 'get', data, true, success);
};
get_resource();
...
var get_version_list = function () {
    ...
    dataTablePage($("#version_table"), aoColumns, ajaxSource, data, false, fnRowCallback);
};
get_version_list();
