...
var CONFIG = ["general", "equip", "props", "map", "copy", "brave_copy", "soul"];
    ...
    var roleidValidation = function () {
        ...
        var submitHandler = function (form) {
            ...
            $.ajax({
                    type: 'get',
                    url: "/getroleinfo",
                    data: {select_role: select_role, role_search: role_search, server_id: server_id},
                    dataType: 'JSON',
                    success: function (data) {
    ...
    var equipValidation = function () {
        ...
        var submitHandler = function (form) {
            ...
            $.ajax({
                    type: 'get',
                    url: '/addequip',
                    data: {server_id: server_id, role_id: role_id, equip_cid: equip_cid, equip_num: equip_num},
                    dataType: 'JSON',
                    success: function (data) {
    ...
    var soulValidation = function () {
        ...
        var submitHandler = function (form) {
            ...
            $.ajax({
                    type: 'get',
                    url: '/addsoul',
                    data: {server_id: server_id, select_role: select_role, role_search: role_id, soul_cid: soul_cid, soul_num: soul_num},
                    dataType: 'JSON',
                    success: function (data) {
                        App.unblockUI(page_content, true);
...
var query_generl = function (general_id){
    ...
    $.ajax({
            ...
            success: function (data) {
                ...
                $("#general_cid").html("<span class='btn " + g_css + "'>" + DATA["general"][g_cid]["name"] + "<span>");
                ...
                if (data["equip"]["horse"] != null) {
                    ...
                    var str_horse = "<span class='btn " + horse_css + "'>" + EQUIP_JSON[horse_cid]["name"] + "</span>" + "LV:" + data["equip"]["horse"]["level1"];
                ...
                if (data["equip"]["weapon"] != null){
                    ...
                    var str_weapon = "<span class='btn " + weapon_css + "'>" + EQUIP_JSON[weapon_cid]["name"] + "</span>" + "LV:" + data["equip"]["weapon"]["level1"];
                ...
                if (data["equip"]["treasure"] != null){
                    ...
                    var str_treasure = "<span class='btn " + treasure_css + "'>" + EQUIP_JSON[treasure_cid]["name"] + "</span>" + "LV:" + data["equip"]["treasure"]["level1"];
                ...
                if (data["equip"]["head"] != null){
                    ...
                    var str_head = "<span class='btn " + head_css + "'>" + EQUIP_JSON[head_cid]["name"] + "</span>" + "LV:" + data["equip"]["head"]["level1"];
                ...
                if (data["equip"]["armor"] != null){
                    ...
                    var str_armor = "<span class='btn " + armor_css + "'>" + EQUIP_JSON[armor_cid]["name"] + "</span>" + "LV:" + data["equip"]["armor"]["level1"];
                ...
                if (data["equip"]["accessory"] != null){
                    ...
                    var str_accessory = "<span class='btn " + accessory_css + "'>" + EQUIP_JSON[accessory_cid]["name"] + "</span>" + "LV:" + data["equip"]["accessory"]["level1"];
                ...
                for(var k =1; k <= 8; k++){
                    ...
                    if(data["soul"]["s" + k] != null){
                        ...
                        str_soul += "<div>" + "<span class='btn " + soul_css + "'>" + SOUL_JSON[soul_cid]["name"] + "</span></div>";
...
function save_role(){
    ...
    $.ajax({
            type: 'get',
            url: '/updaterole',
            data: {game_id: game_id, role_id: role_id, role_vip: role_vip,
                   role_level: role_level, role_exp: role_exp, role_coin: role_coin, role_gold: role_gold,
                   role_stamina: role_stamina, role_energy: role_energy, role_prestige: role_prestige, role_athletics: role_athletics},
            dataType: 'JSON',
            success: function (data) {
                App.unblockUI(page_content);
                if (data["status"] == "fail"){
...
$("#equip").bind("click", function(e){
    ...
    if(v_str){
        ...
        for (var e in EQUIP_JSON){
            equip_str += "<option value='" + e + "'>" + EQUIP_JSON[e]["quality"] + "星:" + EQUIP_JSON[e]["name"] + "</option>";
        }
...
$("#props").bind("click", function(e){
    ...
    if(v_str){
        ...
        for (var p in PROPS_JSON){
            props_str += "<option value='" + p + "'>" + PROPS_JSON[p]["name"] + "</option>";
        }
...
$("#soul").bind("click", function(e){
    ...
    if(v_str){
        ...
        for(var s in SOUL_JSON){
            soul_str += "<option value='" + s + "'>" + SOUL_JSON[s]["quality"] + "星" + SOUL_JSON[s]["name"] + "</option>";
        }
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (tag == 1)
                ...
                copy = DATA["brave_copy"];
            for (var i = 0; i < data.length; i++) {
                str_info += "<tr>";
                str_info += "<td>" + DATA["map"][data[i]["map"]]["name"] + "</td>";
...
$("#brave_copy").on("click", function(e){
    e.preventDefault();
    var v_str = validate_role();
    var role_id = $("#role_id").val();
    if(v_str){
        $("#brave_copy").attr("href", "#tab_brave_copy");
        query_copy(role_id, 2, $("#brave_copy_list"));
    }
});
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for(var d in data){
                ...
                str_info += "<td>";
                if (d > 20000 && d < 21000){
                    str_info += PROPS_JSON[d]["name"];
                }
                else if (d > 21100 && d < 27000){
                    str_info += EQUIP_JSON[d]["name"];
                }
                else{
                    str_info += SOUL_JSON[d]["name"];
                }
                str_info += "</td>";
