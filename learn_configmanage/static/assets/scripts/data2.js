    ...
    var roleidValidation = function () {
        ...
        var submitHandler = function (form) {
            ...
            $.ajax({
                    type: 'get',
                    url: "/getroleinfo",
                    data: {role_search: role_search, server_id: server_id},
                    dataType: 'JSON',
                    success: function (data) {
...
var query_generl = function (general_id){
    ...
    $.ajax({
            ...
            success: function (data) {
                ...
                $("#general_cid").html("<span class='btn " + g_css + "'>" + DATA["general"][g_cid]["name_CN"] + "<span>");
                ...
                if (data["equip"]["horse"] != null) {
                    ...
                    var str_horse = "<span class='btn " + horse_css + "'>" + EQUIP_JSON[horse_cid]["name_CN"] + "</span>" + "LV:" + data["equip"]["horse"]["level1"];
                ...
                if (data["equip"]["weapon"] != null){
                    ...
                    var str_weapon = "<span class='btn " + weapon_css + "'>" + EQUIP_JSON[weapon_cid]["name_CN"] + "</span>" + "LV:" + data["equip"]["weapon"]["level1"];
                ...
                if (data["equip"]["treasure"] != null){
                    ...
                    var str_treasure = "<span class='btn " + treasure_css + "'>" + EQUIP_JSON[treasure_cid]["name_CN"] + "</span>" + "LV:" + data["equip"]["treasure"]["level1"];
                ...
                if (data["equip"]["head"] != null){
                    ...
                    var str_head = "<span class='btn " + head_css + "'>" + EQUIP_JSON[head_cid]["name_CN"] + "</span>" + "LV:" + data["equip"]["head"]["level1"];
                ...
                if (data["equip"]["armor"] != null){
                    ...
                    var str_armor = "<span class='btn " + armor_css + "'>" + EQUIP_JSON[armor_cid]["name_CN"] + "</span>" + "LV:" + data["equip"]["armor"]["level1"];
                ...
                if (data["equip"]["accessory"] != null){
                    ...
                    var str_accessory = "<span class='btn " + accessory_css + "'>" + EQUIP_JSON[accessory_cid]["name_CN"] + "</span>" + "LV:" + data["equip"]["accessory"]["level1"];
                ...
                for(var k =1; k <= 8; k++){
                    ...
                    if(data["soul"]["s" + k] != null){
                        ...
                        str_soul += "<div>" + "<span class='btn " + soul_css + "'>" + SOUL_JSON[soul_cid]["name_CN"] + "</span></div>";
                    ...
                    if (data["general"].length != 0) {
                        for (var k = 0; k < data["general"].length; k++) {
                            ...
                            general_arr[data["general"][k].id] = {
                                "name": GENERAL_JSON[cid]["name_CN"],
                                "quality": QUALITY_CSS[quality]
                            };
                            str_g += GENERAL_JSON[cid]["name_CN"] + "</span></td>";
            ...
            success: function (data) {
                ...
                if (data.length != 0) {
                    for (var e = 0; e < data.length; e++) {
                        ...
                        str_e += EQUIP_JSON[data[e].cid]["name_CN"] + "</span></td>";
...
$("#props").bind("click", function(e){
    ...
    if(v_str){
        ...
        for (var p in PROPS_JSON){
            props_str += "<option value='" + p + "'>" + p + "-" + PROPS_JSON[p]["name_CN"] + "</option>";
        }
            ...
            success: function (data) {
                if (data.length != 0) {
                    ...
                    for (var p = 0; p < data.length; p++) {
                        str_p += "<tr>";
                        str_p += "<td>";
                        str_p += PROPS_JSON[data[p].cid]["name_CN"] + "</td>";
            ...
            success: function (data) {
                if (data.length != 0) {
                    ...
                    for (var s = 0; s < data.length; s++) {
                        ...
                        str_s += SOUL_JSON[data[s].cid]["name_CN"] + "</span></td>";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                str_info += "<tr>";
                str_info += "<td>" + DATA["map"][data[i]["map"]]["name_CN"] + "</td>";

                str_info += "<td>" + copy[data[i]["map"]][data[i]["point"]]["name_CN"] + "</td>";
...
var query_general_copy = function(role_id, div){
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                str_info += "<tr>";
                str_info += "<td>" + DATA["star_map"][data[i]["map"]]["name_CN"] + "</td>";
            ...
            success: function (data) {
                if (data.length != 0) {
                    ...
                    for (var p = 0; p < data.length; p++) {
                        str_p += "<tr>";
                        str_p += "<td>";
                        str_p += PET_JSON[data[p].cid][0]["name_CN"] + "</td>";
            ...
            success: function (data) {
                if (data.length != 0) {
                    ...
                    for (var p = 0; p < data.length; p++) {
                        str_p += "<tr>";
                        str_p += "<td>";
                        str_p += EXPEDITION_JSON[data[p]["cid"]]["name_CN"] + "</td>";
                        if (data[p]["kill"] == "-1") {
                            var status = "成功";
                        } else {
                            var status = "失败";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for(var d in data){
                ...
                str_info += "<td>";
                if (d > 20000 && d < 21000){
                    str_info += PROPS_JSON[d]["name_CN"];
                }
                else if (d > 21100 && d < 27000){
                    str_info += EQUIP_JSON[d]["name_CN"];
                }
                else{
                    str_info += SOUL_JSON[d]["name_CN"];
                }
                str_info += "</td>";
