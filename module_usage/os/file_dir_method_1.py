...
# for root,subdirs,files in os.walk(now_dir):
#     for filepath in files:
#         if re.match(args[1],os.path.splitext(filepath)[0]):
...
#         try:
#             tmppath = tmppath.decode('gbk')#中文解码
#         finally:
#             if os.path.isdir(tmppath):
#                 search(tmppath)
#             elif s in os.path.splitext(tmppath)[0]:
#                 print tmppath
# 
# search(u'补丁', 'E:\Download')