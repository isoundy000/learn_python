...
from learn_twist.dbentrust.memobject import MemObject
from learn_twist.dbentrust import util
import time
...
class MMode(MemObject):
    ...
    def __init__(self, name, pk, data=Dict):
...
class MFKMode(MemObject):
    ...
    def __init__(self, name, pklist=List):
        MemObject.__init__(self, name, mclient)
        self.pklist = pklist
